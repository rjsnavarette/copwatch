...
import com.example.copwatch.utils.BaseFragment;
...
public abstract class CameraVideoFragment extends BaseFragment {
    ...
    private TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture,
            ...
            Log.e(TAG, "onSurfaceTextureAvailable: " + cameraId);
            if (cameraId == null) {
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getActivity());
                if (preferences.getBoolean("Rear_camera", true)) {
                    cameraId = Constants.CAMERA_BACK;
                } else {
                    cameraId = Constants.CAMERA_FRONT;
                }
            }
    ...
    private void showSettingsDialog() {
        ...
        builder.setTitle(R.string.message_need_permission);
        builder.setMessage(R.string.message_permission);
        builder.setPositiveButton(R.string.title_go_to_setting, (dialog, which) -> {
            dialog.cancel();
            openSettings();
        });
        builder.show();
    ...
    public void switchCamera() {
        if (cameraId != null) {
            if (cameraId.equals(Constants.CAMERA_FRONT)) {
                cameraId = Constants.CAMERA_BACK;
                closeCamera();
                reopenCamera();


            } else if (cameraId.equals(Constants.CAMERA_BACK)) {
                cameraId = Constants.CAMERA_FRONT;
                closeCamera();
                reopenCamera();
